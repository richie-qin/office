...
<div id="footer">
    <div id="content1">
        <img id="content1-img" src="../assets/image/qz-logo1.png" alt="">
    ...
    <div id="content3">
        <div id="content3-div1">友情链接</div>
        <div class="content3-top-text">热门办公室出租</div>
        ...
        <div class="content3-text">上海兼职</div>
        <br>
        <!-- <div class="content3-text" v-for="(item) in 6" :key="item">上海兼职</div> -->
        <div class="content3-text">上海兼职</div>
    ...
    <div id="content4">
        <h3>客服服务</h3>
        <div id="content4-tel">4000-623-678</div>
        <div id="content4-time">(早9:00-晚8:00)</div>
        <div id="content4-em">12345678911@qq.com</div>
    </div>
</div>
</template>
<script>
